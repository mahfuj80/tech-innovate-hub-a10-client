const ContactUs = () => {
  return (
    <div>
      <section className="relative z-10 px-8 overflow-hidden bg-[#F3F4F6] dark:bg-gray-900 py-16  lg:py-[80px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color">
                  Need assistance or have inquiries? Feel free to contact us.
                  Our responsive team is ready to help you with any concerns,
                  suggestions, or queries you may have. We value your input!
                </p>
